...
class ImportCoursesToPostgresTests(unittest.TestCase):
    ...
    def test_optional_subject_and_department_columns_are_read_and_reported(self):
        csv_path = self.write_temp_csv(
            "id,name,credits,college,prereqs,subject,department\n"
            "CMPSC 16,Problem Solving,4,College of Engineering,\"CMPSC 8 | ECE 15, ENGR 3\",CMPSC,Computer Science\n"
        ...
        self.assertEqual(plan.headers, ["id", "name", "credits", "college", "prereqs", "subject", "department"])
